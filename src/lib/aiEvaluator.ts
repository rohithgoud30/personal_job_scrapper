...
export async function findIrrelevantJobIds(
  ...
  const systemPrompt = Array.isArray(prompts)
    ...
    : [
        ...
        "Explicitly REJECT any role with 'Staff', 'Senior', 'Sr', 'Lead', 'Principal', 'Manager', 'Director', 'VP', 'Head of', or 'Architect' in the title (e.g., 'Senior Developer', 'Staff Engineer', 'Team Lead', 'Principal Engineer'), even if the technical stack matches.",
